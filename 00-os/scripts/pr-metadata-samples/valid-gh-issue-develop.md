# Summary
- Sample PR body using the recommended `gh issue develop` branch path.

# Issue
- Linked issue (primary tracked issue):
- Primary-Issue-Ref: Closes #54
...
- Development-Linkage-Evidence: GitHub issue #54 Development section shows this PR link.
